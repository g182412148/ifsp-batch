...
* Package: com.ruim.ifsp.paypagydatabase.bean.dto
* FileName: TpamWechatTxnInfo.java
* Author: zhaodengke
...
/**
* 名称：〈TPAM_WECHAT_DC_TXN_INFO〉<br>
* 功能：〈〉<br>
* 方法：〈方法简述 - 方法描述〉<br>
* 版本：1.0 <br>
* 作者：zhaodengke<br>
* 日期：2018-05-14 15:51:59<br>
* 说明：<br>
 */
public class TpamWechatDcTxnInfo extends CommonDTO {
	
    /**
     * 账户(银行账号/微信授权码/支付宝授权码/微信账号/支付账户)：公众号支付openid，参考文档：https://mp.weixin.qq.com/wiki；
     * 支付宝：支付用户标识，参考文档：https://doc.open.alipay.com/docs/doc.htm?treeId=220&articleId=105337&docType=1#s5；微信授权码； 支付宝支付时：支付宝授权码或账号
     */
    protected String acctNo;
    /**
     * 退款资金来源 仅针对老资金流商户使用 REFUND_SOURCE_UNSETTLED_FUNDS---未结算资金退款（默认使用未结算资金退款）  REFUND_SOURCE_RECHARGE_FUNDS---可用余额退款
     */
    protected String tpamRefundAccount;
    ...
    public String getTpamRefundAccount() {
        return tpamRefundAccount;
    }

    public void setTpamRefundAccount(String tpamRefundAccount) {
        this.tpamRefundAccount = tpamRefundAccount == null ? null : tpamRefundAccount.trim();
    }
