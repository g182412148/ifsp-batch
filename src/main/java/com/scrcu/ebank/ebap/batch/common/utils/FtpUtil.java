...
public class FtpUtil {
     ...
     * @param localFile
     */
    public static void uploadFile(String host, int port, String username, String password, String charset,String remoteFile,String localFile)
    {
    	if(charset == null || "".equals(charset))
    	{
    		charset = DEFAULT_CHARSET;
    	}
    	FtpUtil ftpUtil = FtpUtil.createFtpCli(host, port, username, password, charset);
    	try 
    	{
			ftpUtil.connect();
			
			ftpUtil.upload(remoteFile, new File(localFile));
     ...
     * @param localFile
     */
    public static void downloadFile(String host, int port, String username, String password, String charset,String remoteFile,String localFile)
    {
    	if(charset == null || "".equals(charset))
    	{
    		charset = DEFAULT_CHARSET;
    	...
    	try 
    	{
			...
			ftpUtil.download(remoteFile, new File(localFile));
