...
public class TpamCnuniopayQrcTxnInfoVo extends CommonDTO {
    ...
    public String getTpamVoucherNum() {
        return tpamVoucherNum;
    }

    public void setTpamVoucherNum(String tpamVoucherNum) {
        this.tpamVoucherNum = tpamVoucherNum == null ? null : tpamVoucherNum.trim();
    }
